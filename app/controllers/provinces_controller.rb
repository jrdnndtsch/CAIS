class ProvincesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @province.save
        format.html { redirect_to admin_path, notice: 'Province was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @province.update(province_params)
        format.html { redirect_to admin_path, notice: 'Province was successfully updated.' }
  ...
  def destroy
    @province.destroy
    respond_to do |format|
      format.html { redirect_to admin_path, notice: 'Province was successfully destroyed.' }
